...
ucloud.ui.Toolbar = function(itemConfig) {
	var pBtns = [{
				id : 't_reset',
				text : '清屏',
				icon : __ctxPath + '/resources/images/ext/toolbar/query.gif',
				event : 'yfcClear()',
				secLevel : 'PO'
			}, {
				id : 't_search',
				text : '查询',
				icon : __ctxPath + '/resources/images/ext/toolbar/search.gif',
				event : 'yfcSearch()',
				secLevel : 'PO'
			}, {
				id : 't_add',
				text : '增加',
				icon : __ctxPath + '/resources/images/ext/toolbar/add.gif',
				event : 'yfcAdd()',
				secLevel : 'PO'
			}, {
				id : 't_delete',
				text : '删除',
				icon : __ctxPath + '/resources/images/ext/toolbar/delete.gif',
				event : 'yfcDelete()',
				secLevel : 'PO'
			}, {
				id : 't_modify',
				text : '修改',
				icon : __ctxPath + '/resources/images/ext/toolbar/edits.gif',
				event : 'yfcModify()',
				secLevel : 'PO'
			}, {
				id : 't_save',
				text : '保存',
				icon : __ctxPath + '/resources/images/ext/toolbar/save.gif',
				event : 'yfcSave()',
				secLevel : 'P'
			}, {
				id : 't_import',
				text : '导入',
				icon : __ctxPath + '/resources/images/ext/toolbar/import.gif',
				event : 'yfcImport()',
				secLevel : 'P'
			}, {
				id : 't_export',
				text : '导出',
				icon : __ctxPath + '/resources/images/ext/toolbar/export.gif',
				event : 'yfcExport()',
				secLevel : 'P'
			}];
	var config = {
