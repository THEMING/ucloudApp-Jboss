    ...
    return {
        ...
        getDialog : function(titleText){
           if(!dlg){
                ...
                buttons = {};
                Ext.each(buttonNames, function(name){
                    btns.push(buttons[name] = new ZTESOFT.Button({
        ...
        updateText : function(text){
            ...
            if(dlg.getSize().height<200){
            	dlg.setSize(w, 160).center();
            }
            return this;
        },
        ...
        alert : function(title, msg, fn, scope){
        	msg = '<span style="font-size:12px; font-family:微软雅黑; color:#D7191F">温馨提示:</span><br>'
        		+'<span style="padding-left:60px;">'+msg+'</span>';
            this.show({
                title : title,
                msg : msg,
                buttons: this.OK,
