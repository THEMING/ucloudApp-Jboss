...
public class SessionFilter_caojz implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        if (account == null) {
            ...
            try {
                ...
                userAccount.put("userId", "caojz10");
                userAccount.put("accountId", "caojz10");
                userAccount.put("userEmpName", "曹景镇");
